                                        ...
                                        <div className="itemRow flex" key={'leftMedalsRow' + leftMedalsRowIndex}>
                                            {leftMedalsArray.map((leftMedal, leftMedalCellIndex) => {
                                                if (leftMedal) {
                                                    return (
                                                        <div
                                                            id={"leftMedal" + leftMedalsRowIndex + "-" + leftMedalCellIndex}
                                                            className={'smallItemCell'}
                                                            key={'leftMedalRow' + leftMedalCellIndex}>
                                                            <div className={'flex'}
                                                                 onClick={() => deleteItemFromSelected(leftMedalsRowIndex, leftMedalCellIndex, leftMedal)}>
                                                                <img className={'imgw20'} src={getFile64(leftMedal)}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                    )
                                                    ...
                                                    return (
                                                        <div
                                                            id={"leftMedal" + leftMedalsRowIndex + "-" + leftMedalCellIndex}
                                                            className={'smallItemCell'}
                                                            key={'signRow' + leftMedalCellIndex}></div>
                                                    )
                                                }
                                            })}
                                        </div>
                                    ...
                                    return (
                                        <div className="itemRow flex" key={'gradeRow' + gradeRowIndex}>
                                            {gradeArray.map((grade, gradeCellIndex) => {
                                                if (grade) {
                                                    return (
                                                        <div id={"grade" + gradeRowIndex + "-" + gradeCellIndex}
                                                             className={'gradeItemCell'}
                                                             key={'gradeMedalRow' + gradeCellIndex}>
                                                            <div className={'flex'}
                                                                 onClick={() => deleteItemFromSelected(gradeRowIndex, gradeCellIndex, grade)}>
                                                                <img className={'imgw40'} src={getFile64(grade)}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                    )
                                                    ...
                                                    return (
                                                        <div id={"grade" + gradeRowIndex + "-" + gradeCellIndex}
                                                             className={'gradeItemCell'}
                                                             key={'signRow' + gradeCellIndex}></div>
                                                    )
                                                }
                                            })}
                                        </div>
                            ...
                            return (
                                <div className="itemRow flex" key={'signRow' + signRowIndex}>
                                    {signRowArray.map((sign, signCellIndex) => {
                                        if (sign) {
                                            return (
                                                <div id={"sign" + signRowIndex + "-" + signCellIndex}
                                                     className={'itemCell'} key={'signRow' + signCellIndex}>
                                                    <div className={'flex'}
                                                         onClick={() => deleteItemFromSelected(signRowIndex, signCellIndex, sign)}>
                                            ...
                                            return (
                                                <div id={"sign" + signRowIndex + "-" + signCellIndex}
                                                     className={'itemCell'} key={'signRow' + signCellIndex}></div>
                                            )
                                        }
                                    })}
                                </div>
                                        ...
                                        <div className="itemRow flex" key={'rightMedalsRow' + rightMedalsRowIndex}>
                                            {rightMedalsArray.map((rightMedal, rightMedalCellIndex) => {
                                                if (rightMedal) {
                                                    return (
                                                        <div
                                                            id={"rightMedal" + rightMedalsRowIndex + "-" + rightMedalCellIndex}
                                                            className={'smallItemCell'}
                                                            key={'rightMedalRow' + rightMedalCellIndex}>
                                                            <div className={'flex'}
                                                                 onClick={() => deleteItemFromSelected(rightMedalsRowIndex, rightMedalCellIndex, rightMedal)}>
                                                                <img className={'imgw20'} src={getFile64(rightMedal)}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                    )
                                                    ...
                                                    return (
                                                        <div
                                                            id={"rightMedal" + rightMedalsRowIndex + "-" + rightMedalCellIndex}
                                                            className={'smallItemCell'}
                                                            key={'signRow' + rightMedalCellIndex}></div>
                                                    )
                                                }
                                            })}
                                        </div>
                ...
                <div id="medalsItemsView" className={'flex'}>
                        ...
                        if (formStep === 'rightItemsStep') {
                            return (
                                <button className={'circleBtn'}
                                        onClick={() => changeItemsInRow(false, 'rightItem')}>-</button>
                            )
                        }
                    })()}
                            ...
                            return (
                                <div className="itemRow flex" key={'medalRow' + medalRowIndex}>
                                    {medalRowArray.map((medal, medalCellIndex) => {
                                        if (medal) {
                                            return (
                                                <div id={"medal" + medalRowIndex + "-" + medalCellIndex}
                                                     className={'itemCell'} key={'medalRow' + medalCellIndex}>
                                                    <div className={'absolute'}
                                                         onClick={() => deleteItemFromSelected(medalRowIndex, medalCellIndex, medal)}>
                                                        <img className={'imgw30 zInd' + medalRowIndex}
                                                             src={getFile64(medal)} alt=""/>
                                                    </div>
                                                </div>
                                            )
                                        } else {
                                            return (
                                                <div id={"medal" + medalRowIndex + "-" + medalCellIndex}
                                                     className={'itemCell'} key={'medalRow' + medalCellIndex}></div>
                                            )
                                        }
                                    })}
                                </div>
                    ...
                    {(() => {
                        if (formStep === 'rightItemsStep') {
                            return (
                                <button className={'circleBtn'}
                                        onClick={() => changeItemsInRow(true, 'rightItem')}>+</button>
                            )
                        }
                    })()}
                </div>
                            ...
                            <div className="chooseForm">
                                <div>
                                                        ...
                                                        {formCategory.categoryItems.map((category, index) => {
                                                            return (
                                                                <div className={formCategory}
                                                                     onClick={() => nextCategory(category.name)}
                                                                     key={category.name + index}>
                                                                    <div className={'categoryNameContainer'}>
                                                                        <span
                                                                            className={'categoryName'}> {category.name} </span>
                                                                    </div>
                                            ...
                                            if (!isLoading) {
                                                return (
                                                    <div>
                                                        <h2>Список форм</h2>
                                                        <div className={'flex'}>
                                                            <sp-textfield value={formsSearch} onInput={searchForms}
                                                                          class="searchInput" id="searchFormsInput"
                                                                          type="search">
                                                            </sp-textfield>
                                                            <img onClick={() => searchForms(null)} src={clearImg}
                                                                 className={'clearImg'} alt=""/>
                                                        </div>
                                                        ...
                                                        <sp-card id="formList">
                                                            <sp-menu className={'select-menu'}>
                                                                {filteredForms.map((form, index) => {
                                                                    return (
                                                                        <sp-menu-item
                                                                            onMouseEnter={() => showFormPreview(form)}
                                                                            onMouseLeave={() => hideFormPreview()}
                                                                            onClick={() => toSignsAndMedals(form)}
                                                                            className={'searchFormsBtn'}
                                                                            key={form.name + index}>
                                                                            <div className={'menu-item'}>
                                                                                <span>{form.name}</span>
                                                                                <img className={'imgw60'}
                                                                                     src={getStrap(form)} alt=""/>
                                                                            </div>
                                                                        </sp-menu-item>
                                                                    )
                                                                })}
                                    ...
                                    {currentFormFolder.length > 3 && !isLoading ?
                                        <sp-button id="prevCategoryBtn" onClick={prevCategory}>Назад</sp-button> : null}
                                    {currentFormFolder.length === 3 && !isLoading ?
                                            ...
                                            {formTypes.map((formType, index) => {
                                                return (
                                                    <div className={'formTypeImg'} key={formType.name + index}>
                                                        <img onClick={() => changeCurrentFormType(formType)}
                                                             src={formType.file?.file64} alt=""/>
                                                    </div>
                                                )
                                            })}
                                        </div> : null}
                                        ...
                                        return (
                                            <div>
                                                ...
                                                <div className={'flexTables'}>
                                                    <div id={'toSignsBlock'} className={'flex-column'}
                                                         onClick={() => changeStep('signsStep')}>
                                                        {/*К значкам*/}
                                                        <div className={'common-table-title-container'}>
                                                            <img className={'common-table-title-img'} src={arrowLeftImg}
                                                                 alt=""/>
                                                    ...
                                                    <div id={'toMedalsBlock'} className={'flex-column'}
                                                         onClick={() => changeStep('rightItemsStep')}>
                                                        {/*К медалям*/}
                                                        <div className={'common-table-title-container'}>
                                                            <span className={'common-table-title'}>К медалям</span>
                                                            <img className={'common-table-title-img'}
                                                    ...
                                                    if (currentForm.config['rightItemsDefault'] === 'plank') {
                                                        return (
                                                            <div className={'flex'} id="initials">
                                                                <sp-textfield value={initials}
                                                                              onInput={setInitialsValue}
                                                                              placeholder="Фамилия И.О."
                                                                              id="initialInput"
                                                                              type="input"></sp-textfield>
                                                            </div>
                                                        )
                                                    }
                                                })()}
                                                    ...
                                                    if (!isLoading) {
                                                        return (
                                                            <div id={'controlButtons'}>
                                                                <button onClick={() => backToChooseCategories()}>К
                                                                    списку форм
                                                                </button>
                                                                <sp-button
                                                                    onClick={() => insertFormToPhotoshop()}>Подставить
                                                                    форму
                                                                </sp-button>
                                                            </div>
                                                        )
                                        ...
                                        return (
                                            <div>
                                                ...
                                                <div className={'formItems'}>
                                                    ...
                                                    {/*поиск*/}
                                                    <div className={'flex'}>
                                                        <sp-textfield value={signsSearch} onInput={searchSigns}
                                                                      class="searchInput" type="search">
                                                        </sp-textfield>
                                                        <img onClick={() => searchSigns(null)} className={'clearImg'}
                                                             src={clearImg} alt=""/>
                                                    </div>
                                                    {/*список*/}
                                                    {(() => {
                                                                    ...
                                                                    <sp-card id="signList">
                                                                        <sp-menu className={'select-menu'}>
                                                                            {filteredSigns.map((sign, index) => {
                                                                                return (
                                                                                    <sp-menu-item
                                                                                        onMouseEnter={() => showItemPreview(sign)}
                                                                                        onMouseLeave={() => hideItemPreview()}
                                                                                        onClick={() => addItemToSelected(sign)}
                                                                                        className={'searchFormsBtn'}
                                                                                        key={sign.name + index}>
                                                                                        <div className={'menu-item'}>
                                                                                            <span>{sign.name}</span>
                                                                                            <img
                                                                                                className={getPreviewItemSizeInList(sign)}
                                                                                                src={getFile64(sign)}
                                                                                                alt=""/>
                                                                                        </div>
                                                                                    </sp-menu-item>
                                                ...
                                                <div id={'controlButtons'}>
                                                    <button className={'doneBtn'}
                                                            onClick={() => changeStep('common')}>Завершить
                                                    </button>
                                                    <sp-button onClick={() => changeStep('rightItemsStep')}>К медалям
                                                    </sp-button>
                                                </div>
                                                {/*ВЫБРАННЫЕ АЙТЕМЫ*/}
                                                <div className={'flexTables'}>
                                                ...
                                                <div>
                                                    <div className={'formItems'}>
                                                        <div className={'flex'}>
                                                            ...
                                                            <button
                                                                onClick={() => switchRightItems()}>{getSwitchName(rightItemName)}</button>
                                                        </div>

                                                        {/*поиск*/}
                                                        <div className={'flex'}>
                                                            <sp-textfield value={medalsSearch} onInput={searchMedals}
                                                                          class="searchInput" type="search">
                                                            </sp-textfield>
                                                            <img onClick={() => searchMedals(null)}
                                                                 className={'clearImg'} src={clearImg} alt=""/>
                                                        </div>
                                                                        ...
                                                                        <sp-card id="medalList">
                                                                            <sp-menu className={'selectMenu'}>
                                                                                {filteredMedals.map((medal, index) => {
                                                                                    return (
                                                                                        <sp-menu-item
                                                                                            onMouseEnter={() => showItemPreview(medal)}
                                                                                            onMouseLeave={() => hideItemPreview()}
                                                                                            onClick={() => addItemToSelected(medal)}
                                                                                            className={'searchFormsBtn'}
                                                                                            key={medal.name + index}>
                                                                                            <div
                                                                                                className={'menu-item'}>
                                                                                                <span
                                                                                                    className={rightItemName === 'medal' ? 'yellowItems' : 'redItems'}>{medal.name}</span>
                                                                                                <img
                                                                                                    className={getPreviewItemSizeInList(medal)}
                                                                                                    src={getFile64(medal)}
                                                                                                    alt=""/>
                                                                                            </div>
                                                                                        </sp-menu-item>
                                                        ...
                                                        <div id={'controlButtons'}>
                                                            <sp-button onClick={() => changeStep('signsStep')}>К
                                                                значкам
                                                            </sp-button>
                                                            <button className={'doneBtn'}
                                                                    onClick={() => changeStep('common')}>Завершить
                        ...
                        return (
                            <div id={'afterFormInsertMenu'}>
                                <div className={'final-screen'}>
                                    <div className={'flex'}>
                                        <sp-button class="big-blue-button" onClick={() => toNewForm()}>Новая форма
                                        </sp-button>
                                    </div>
            ...
            <div className={'flex-column'}>
                ...
                <div className={'template-items flex'}>
                    {templates.map((template, index) => {
                        return (
                            <div onClick={() => onTemplateClick(template)} key={template.name + index}
